...
#Save the plot to the 'figures' folder
anim_save(
    here("figures", "animated_plot.gif"),
    animation = anim2,
    width = 600,  # Width of the output in inches
    height = 480,  # Height of the output in inches
    dpi = 300    # Resolution (dots per inch) to control image quality
)
```
